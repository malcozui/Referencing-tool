...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="data">
    <general>
      ...
      <comments>
        This is version 1.7 of malcoms VEGA-IIE xsl sheet
      </comments>
    ...
    <bibliography>
      ...
      <source type="Art">
        <column id="1">
          <halign>left</halign>
          <valign>top</valign>
          <format>{%Artist:2|"Anon."%}{ %Year|"n.d."%{%YearSuffix%}.}{ &lt;i&gt;%Title|ShortTitle%&lt;/i&gt;.}{%City%: %Publisher%. }{ [%Medium%].}{ Available at: &lt;u&gt;%URL:l%&lt;/u&gt;{ [accessed{{ %DayAccessed%} %MonthAccessed:s%} %YearAccessed%]}}.{ %Comments%.}</format>
        </column>
